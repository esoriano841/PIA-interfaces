...
<body>
    ...
    <main>
        <section class="contenido-textos">
            <h1>Materias con la inicial G</h1>
        </section>
    <div id="main-container">
        <table>
            ...
            <?php 
                $sql = mysqli_query($con, "SELECT nombre_materia, semestre, nombre_maestro, apellido_paterno, apellido_materno FROM hora_salon INNER JOIN materia ON id_materia = idmateria INNER JOIN maestro ON id_maestro = idmaestro where nombre_materia LIKE  'G%'");
